...
#   - Ex: hexpm/elixir:1.16.1-erlang-26.2.3-debian-bookworm-20231009-slim
#
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/tuxland ./
